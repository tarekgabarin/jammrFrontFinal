...
class SearchSettingsNavBar extends Component {
                ...
                <nav className="navbar is-fixed-top has-text-white is-primary">
                    ...
                    <div className="navbar-brand">
                        ...
                        <div className="navbar-item is-active is-hidden-desktop">
                            ...
                            <span className="has-text-white">My Search Preferences</span>
...
export default connect(null, mapDispatchtoProps)(SearchSettingsNavBar);
